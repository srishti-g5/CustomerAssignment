<%-- 
    Document   : SearchCode
    Created on : 2 Feb, 2024, 10:26:54 PM
    Author     : sgsri
--%>
...
PreparedStatement ps=con.prepareStatement("select first_name,last_name,address,city,state,email,phone,id from customers where first_name=?");
...
PreparedStatement ps=con.prepareStatement("select first_name,last_name,address,city,state,email,phone,id from customers where city=?");
ps.setString(1,searchTerm);
...
PreparedStatement ps=con.prepareStatement("select first_name,last_name,address,city,state,email,phone,id from customers where state=?");
ps.setString(1,searchTerm);
...
PreparedStatement ps=con.prepareStatement("select first_name,last_name,address,city,state,email,phone,id from customers where id=?");
ps.setInt(1,id);
...
<link rel="stylesheet" type="text/css" href="//netdna.bootstrapcdn.com/font-awesome/4.1.0/css/font-awesome.min.css">
     ...
     New Customer</a>
                    ...
                    <div>
        <form action="SearchCode.jsp" method="get">
            <label>Search By:
